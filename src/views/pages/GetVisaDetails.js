...
function GetVisaDetailspage(props) {
  ...
  return (
    <>
		<IndexNavbar />
<<<<<<< HEAD
		<div className="wrapper relative_holder">
...
>>>>>>> f7ad9d107f97c9fbe465f1ed37b67108537234dd
			...
			<div className=" bg-light">
				<Row>
					...
					<Col sm="8" className=" p-5"><div className=" Country_visa_details">


					<Card body>
          <CardTitle tag="h2">Armeina eVisa Information</CardTitle>
          <CardText>
...
<li>For most travelers, that's it! However, travelers from India and certain other countries are required to supply additional documentation. READ ON if you're an Indian citizen, or a citizen from any of the countries marked with *** or ** on the "Armeina eVisa: Am I eligible?" section, above.</li>
</ul>
...
<p>IF YOUR COUNTRY IS MARKED *** in the "Armeina eVisa: Am I eligible?" section, above, please provide: Proof of a hotel booking in Armeina. If the traveler is staying with a relative, it may be necessary to provide a copy of the relative’s CPR Reader’s printout.</p>
<p>IF YOUR COUNTRY IS MARKED ** in the "Armeina eVisa: Am I eligible?" section, above, please provide: Copy of a stamped bank statement under the applicant's name, covering the last three months, with a current balance of not less than the equivalent of BD300 (about USD800).</p>
